...
Cartographie des dernières observations complémentaires sur la région.
...
```{r bilan observation, fig.height = 6, fig.width = 9, align = "center", warning = FALSE}
#####-----------
### plot 3 modalites
plot_obs3mod <-
...
```{r bilan heatmap, fig.height = 6, fig.width = 9, align = "center", warning = FALSE}
###
plot_heatmap <-
heatmap_df %>% 
  ggplot() + 
...
```{r bilan duree, fig.height = 6, fig.width = 9, align = "center", warning = FALSE}
plot_duree_assecs <-
  duree_assecs_df %>%
  filter(label != '0 mois') %>% 
